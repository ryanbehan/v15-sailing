...
> [!WARNING]
> **Do Not Overheat:** Keep the surface temperature below 100°F (38°C). You want to evaporate the moisture, not delaminate the fiberglass skins. If in doubt, dry longer at lower heat.

### 4. Injection
Now we rebuild the core.
1.  **Mask off** the area with painter's tape to protect your non-skid.
2.  **Mix your epoxy** with high-density filler. You're aiming for a consistency slightly thinner than peanut butter—flowable, but not runny.
3.  **Inject** the mixture into both holes using the syringe. Fill them completely until a little excess squeezes out.

### 5. The Cure & Re-install
Allow the epoxy to cure for **5 to 6 hours**.
1.  Sand the epoxy flush with the deck.
2.  Drill a **1/8” pilot hole** into the center of your solid epoxy plugs.
3.  **Bed the hardware**: Mix a small batch of *unthickened* epoxy. Drip a little into the pilot holes and dip your new screws in it.
4.  Install the eyestrap with the #10 self-tapping screws. The epoxy on the threads will seal the hole and lock the screw in place.
